...
export const translations = {
  pt: {
    ...
    portal: {
      ...
      statPubs: "PUBLICAÇÕES",
      network: "Rede de Pesquisadores",
      viewProfile: "Ver perfil público",
      commandCenter: "Central de Comando",
      logout: "Sair",
      bioTab: { pt: "Português", en: "Inglês", fr: "Francês" },
      saved: "Salvo com sucesso.",
      errorSave: "Falha ao salvar. Tente novamente.",
      exchangeCountry: "PAÍS DE INTERCÂMBIO",
  ...
  en: {
    ...
    portal: {
      ...
      network: "Researcher Network",
      viewProfile: "View public profile",
      commandCenter: "Command Center",
      logout: "Log out",
      bioTab: { pt: "Portuguese", en: "English", fr: "French" },
  ...
  fr: {
    ...
    portal: {
      ...
      statPubs: "PUBLICATIONS",
      network: "Réseau de Chercheurs",
      viewProfile: "Voir le profil public",
      commandCenter: "Centre de Commande",
      logout: "Déconnecter",
      bioTab: { pt: "Portugais", en: "Anglais", fr: "Français" },
